...
class STACReader(
    ...
    include_asset_types: Set[str] = {'image/jp2', 'application/x-hdf5', 'image/tiff; application=geotiff; profile=cloud-optimized', 'image/x.geotiff', 'image/vnd.stac.geotiff; cloud-optimized=true', 'image/tiff', 'application/x-hdf', 'image/tiff; application=geotiff'},
